...
From my study, I found that as ocean temperature increases, giant kelp frond elongation rate decreases. I found a moderate negative relationship between ocean temperature and giant kelp frond elongation rate (Pearson's r = -0.69, t(30) = -5.12, p < 0.001, $\alpha$ = 0.05).
